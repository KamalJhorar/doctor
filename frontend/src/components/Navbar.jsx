      ...
      <div className='flex items-center gap-4'>
        {
          token&&userdata ? <div className='flex items-center gap-2 cursor-pointer group relative'>
            ...
            <div className='absolute top-0 right-0 pt-14 text-base font-medium text-gray-500 hidden group-hover:block'>
              <div className='min-w-40 bg-stone-200 flex flex-col gap-4 p-4 '>
        ...
        {/* mobile menu */}
<div className={`fixed md:hidden right-0 top-0 bottom-0 z-20 bg-white w-full max-w-xs transition-transform duration-300 ${showmenu ? 'translate-x-0' : 'translate-x-full'}`}>
